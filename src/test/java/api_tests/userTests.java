...
public class userTests {
	...
	public void testUser() {
		Response resp = endpointActions.createUser(pj);   // save the respnse
	...
	public void testGetUserByName() {
		Response resp = endpointActions.getUser(this.pj.getUsername());
		resp.then().log().all();
		Assert.assertEquals(resp.getStatusCode(),200);
	}
	...
	public void testputUser() {
		...
		Response resp = endpointActions.updateUser(pj,this.pj.getUsername());   // 2 params - payload and username
		//System.out.println(resp);
		resp.then().log().all();
		Assert.assertEquals(resp.getStatusCode(), 200);
...
//		
	...
	public void testdeletebyUser() {
			...
			Response resp = endpointActions.deleteUser(this.pj.getUsername());
			resp.then().log().all();
			Assert.assertEquals(resp.getStatusCode(),200);
		}
	}
